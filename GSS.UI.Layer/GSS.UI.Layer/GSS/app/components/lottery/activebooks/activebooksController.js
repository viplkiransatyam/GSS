angular.module('GasApp').controller("ActivebooksController", ['$scope', '$rootScope', '$filter', 'lotteryService', function ($scope, $rootScope, $filter, lotteryService) {   
    ...
    $scope.addBox = function () {
        ...
        if (!angular.isUndefined($scope.activeBooks.gameNumber_1) && $scope.activeBooks.gameNumber_1 != "") {
            fullGame = $scope.activeBooks.gameNumber_1;
            digit = 3;
        }
        else if (!angular.isUndefined($scope.activeBooks.gameNumber_2) && $scope.activeBooks.gameNumber_2 != "") {
            fullGame = $scope.activeBooks.gameNumber_2;
            digit = 4;
        }

        if (angular.isUndefined(fullGame) || fullGame == "" || fullGame == null) {
            ...
            if (digit == 3) {
                ...
                gameId[0] = fullGame.substring(0, 4);
                gameId[1] = fullGame.substring(4, 10);
                gameId[2] = fullGame.substring(10, 13);
            }
                        ...
                        if(hasAddObject){
                            ...
                            for (var i = 0; i < allGames.length; i++) {
                                if(allGames[i].GameID == gameId[0]){
                                    ...
                                    $scope.activeBooks.gameNumber_1 = "";
                                    $scope.activeBooks.gameNumber_2 = "";
                                    $scope.activeBooks.BoxNo = null;
                                    return;
                                }                        
                            }          
