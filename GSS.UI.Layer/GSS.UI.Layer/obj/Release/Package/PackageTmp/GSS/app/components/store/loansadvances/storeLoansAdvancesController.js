angular.module('GasApp').controller('storeLoansAdvancesController', ['$scope', '$http', '$filter', '$rootScope', 'storeService', function ($scope, $http, $filter, $rootScope, storeService) {
